// @ts-nocheck —— 中间态：取数层/零碎件走 kb-shims（@buildingai/services/web, @buildingai/utils/format, @/components/file-fomat-icons, @/utils/format）。
// 真取数层接线见 docs/实施计划/知识库前端-移植清单-v1.md §8 第 3 步（KB）与
// docs/实施计划/管理端BuildingAI移植-台账-v1.md（其余页面）；替换后删掉本行。
/**
 * 移植自 BuildingAI-26.1.2：packages/@buildingai/web/ui/src/../../../../client/src/pages/datasets/detail/_components/document-table.tsx
...
import { bytesToReadable } from "../../../../../kb-shims/ui";
import {
  ArrowLeftRightIcon,
  FilesIcon,
  FileText,
